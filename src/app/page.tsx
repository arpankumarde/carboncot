...
const features = [
  {
    ...
    description:
      "All projects are certified by leading standards like Verra and Gold Standard, ensuring credibility and transparency.",
    icon: "✓",
  },
  {
    title: "Instant Certificates",
    description:
      "Receive digital retirement certificates immediately after purchase, ready to share and download.",
    icon: "📜",
  },
  {
    title: "Transparent Pricing",
    description:
      "Clear pricing with no hidden fees. See exactly what you're paying for each credit.",
    icon: "💰",
  },
  {
    title: "SDG Impact",
    description:
      "Every project supports UN Sustainable Development Goals, creating positive social and environmental impact.",
    icon: "🌍",
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-green-900 mb-8 leading-relaxed">
              Explore verified carbon projects, purchase credits, and receive
              instant retirement certificates. Transparent, credible, and
              simple.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-green-900 max-w-2xl mx-auto">
              ...
              Each project is certified and contributes to sustainable
              development.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-green-900">
                Explore verified carbon projects by country, type, and
                certification standard. View detailed information about each
                project.
              </p>
            </div>
            <div className="text-center">
